               ...
               <div class="card">
                  <div class="card-body">
                     <div class="email-app-sidebar">
                        <div class="media">
                           <div class="media-size-email"><img class="mr-3 rounded-circle" src="<?php echo e(route('/')); ?>/assets/images/user/user.png" alt=""></div>
                              ...
                              <div class="email-top">
                                 <div class="row">
                                    <div class="col-md-6 xl-100 col-sm-12">
                                       <div class="media">
                                          <img class="mr-3 rounded-circle" src="<?php echo e(route('/')); ?>/assets/images/user/user.png" alt="">
                                          <div class="media-body">
                              ...
                              <div class="email-wrapper">
                                 ...
                                 <div class="attachment">
                                    <ul class="list-inline">
                                       <li class="list-inline-item"><img class="img-fluid" src="<?php echo e(route('/')); ?>/assets/images/email/1.jpg" alt=""></li>
                                       <li class="list-inline-item"><img class="img-fluid" src="<?php echo e(route('/')); ?>/assets/images/email/2.jpg" alt=""></li>
                                       <li class="list-inline-item"><img class="img-fluid" src="<?php echo e(route('/')); ?>/assets/images/email/3.jpg" alt=""></li>
                                    </ul>
                                 </div>
                                 <hr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OGP 3\resources\views/new_apps/email-application.blade.php ENDPATH**/ ?>