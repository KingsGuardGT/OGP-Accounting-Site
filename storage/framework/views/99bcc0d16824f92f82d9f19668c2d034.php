...
<script src="<?php echo e(route('/')); ?>/assets/js/icons/icons-notify.js"></script>
<script src="<?php echo e(route('/')); ?>/assets/js/icons/icon-clipart.js"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OGP 3\resources\views/icons/font-awesome.blade.php ENDPATH**/ ?>