<?php $__env->startSection('title', 'Video Chart'); ?>
                     ...
                     <div class="chat">
                        ...
                        <div class="chat-history">
                           <div class="row">
                              ...
                              <div class="col-sm-7 pl-0 caller-img"><img class="img-fluid" src="<?php echo e(asset('assets/images/other-images/caller.jpg')); ?>" alt=""></div>
                           </div>
                        </div>
                        <!-- chat-history ends-->
                        <!-- chat end-->
...
<script src="<?php echo e(route('/')); ?>/assets/js/fullscreen.js"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OGP 3\resources\views/new_apps/chat-video.blade.php ENDPATH**/ ?>