         ...
         <div class="col-sm-12">
            <div class="card hovercard text-center">
               ...
               <div class="user-image">
                  <div class="avatar"><img alt="" src="<?php echo e(route('/')); ?>/assets/images/user/7.jpg"></div>
            ...
            <div class="card">
               <div class="profile-img-style">
                  <div class="row">
                     <div class="col-sm-8">
                        <div class="media">
                           <img class="img-thumbnail rounded-circle mr-3" src="<?php echo e(route('/')); ?>/assets/images/user/7.jpg" alt="Generic placeholder image">
                  ...
                  <div class="img-container">
                     <div class="my-gallery" id="aniimated-thumbnials" itemscope="">
                        <figure itemprop="associatedMedia" itemscope="">
                           <a href="<?php echo e(route('/')); ?>/assets/images/other-images/profile-style-img3.png" itemprop="contentUrl" data-size="1600x950"><img class="img-fluid rounded" src="<?php echo e(route('/')); ?>/assets/images/other-images/profile-style-img3.png" itemprop="thumbnail" alt="gallery"></a>
               ...
               <div class="profile-img-style">
                  ...
                  <div class="row mt-4 pictures my-gallery" id="aniimated-thumbnials-2" itemscope="">
                     <figure class="col-sm-6" itemprop="associatedMedia" itemscope="">
                        <a href="<?php echo e(route('/')); ?>/assets/images/other-images/profile-style-img3.png" itemprop="contentUrl" data-size="1600x950"><img class="img-fluid" src="<?php echo e(route('/')); ?>/assets/images/other-images/profile-style-img.png" itemprop="thumbnail" alt="gallery"></a>
                        <figcaption itemprop="caption description">Image caption  1</figcaption>
                     </figure>
                     <figure class="col-sm-6" itemprop="associatedMedia" itemscope="">
                        <a href="<?php echo e(route('/')); ?>/assets/images/other-images/profile-style-img3.png" itemprop="contentUrl" data-size="1600x950"><img class="img-fluid" src="<?php echo e(route('/')); ?>/assets/images/other-images/profile-style-img.png" itemprop="thumbnail" alt="gallery"></a>
                  ...
                  <div class="row">
                     <div class="col-lg-12 col-xl-4">
                        <div class="my-gallery" id="aniimated-thumbnials-3" itemscope="">
                           <figure itemprop="associatedMedia" itemscope="">
                              <a href="<?php echo e(route('/')); ?>/assets/images/blog/img.png" itemprop="contentUrl" data-size="1600x950"><img class="img-fluid rounded" src="<?php echo e(route('/')); ?>/assets/images/blog/img.png" itemprop="thumbnail" alt="gallery"></a>
                              <figcaption itemprop="caption description">Image caption  1</figcaption>
                           </figure>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OGP 3\resources\views/new_apps/user-profile.blade.php ENDPATH**/ ?>