...
Route::prefix('site')->group(function () {
    ...
    Route::view('history', 'site.history')->name('site.history');
    Route::view('exchange-rates', 'site.exchange-rates')->name('site.exchange-rates');
    Route::view('clients', 'site.clients')->name('site.clients');
    ...
    Route::get('find-us', [\App\Http\Controllers\FindUsController::class, 'show'])->name('site.find-us');
});
